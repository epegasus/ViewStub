package dev.pegasus.viewstub

import android.os.Bundle
import android.os.Handler
import android.os.Looper
import androidx.appcompat.app.AppCompatActivity
import dev.pegasus.viewstub.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       /* withDelay(1000) { binding.viewStub1.inflate() }
        withDelay(1100) { binding.viewStub2.inflate() }
        withDelay(1200) { binding.viewStub3.inflate() }
        withDelay(1300) { binding.viewStub4.inflate() }*/
